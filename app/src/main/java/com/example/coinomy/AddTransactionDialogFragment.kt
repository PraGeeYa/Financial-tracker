package com.example.coinomy
                                    ...
                                    class AddTransactionDialogFragment : DialogFragment() {
                                        ...
                                        private fun validateInputs(): Boolean {
                                            ...
                                            if (title.length > 50) {
                                                etTitle.error = "Title cannot exceed 50 characters"
                                                etTitle.requestFocus()
                                                return false
                                            }
                                            ...
                                            if (amount > 999999.99) {
                                                etAmount.error = "Amount cannot exceed 999,999.99"
                                                etAmount.requestFocus()
                                                return false
                                            }
                                            ...
                                            if (category.length > 30) {
                                                etCategory.error = "Category cannot exceed 30 characters"
                                                etCategory.requestFocus()
                                                return false
                                            }
                                            ...
                                            if (description.length > 200) {
                                                etDescription.error = "Description cannot exceed 200 characters"
